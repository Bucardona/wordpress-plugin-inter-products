...
{
  //add_rewrite_rule( 'productos/([^\/\s]+)[/]?$', 'index.php?inter_product=$matches[1]', 'top' );
  //add_rewrite_rule( 'productos/([^\/\s]+)/?$', 'index.php?inter_product=$matches[1]', 'top' );
  //add_rewrite_rule( 'productos/([^\/\s]+)/([^\/\s]+)/?$', 'index.php?inter_post_type=$matches[1]&inter_term=$matches[2]', 'top' );
